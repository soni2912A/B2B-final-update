    ...
    <>
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .reg-right { width: 100%; min-height: 100vh; border-left: none; padding: 2.5rem 1.75rem; }
          .reg-card.mounted { margin-top: 0; }
        }
        @media (max-width: 420px) {
          ...
          .reg-sub { font-size: 0.78rem; margin-bottom: 1rem; }
          .reg-btn { height: 48px; font-size: 0.85rem; }
          .dark-input-r { padding: 0.7rem 0.8rem !important; font-size: 0.9rem !important; min-height: 44px; }
          .success-box { padding: 1.5rem 1rem; }
        }
        @media (max-width: 340px) {
          .reg-right { padding: 1.25rem 0.75rem; }
                  ...
                  <form onSubmit={goToStep2}>
                    ...
                    <div className="form-row">
                      <div className="form-group-r">
                        ...
                        <input type="text" value={form.name} onChange={set('name')} placeholder="Jane Smith" required className="dark-input-r" />
                      </div>
                      <div className="form-group-r">
                        <label className="dark-label-r">Phone</label>
                        <div style={{display:'flex',gap:'6px'}}>
                          <select value={form.phone.startsWith('+') ? form.phone.split(' ')[0] : '+91'}
                            onChange={e => { const cc=e.target.value; const num=form.phone.replace(/^\+\d+\s*/,''); setForm(f=>({...f,phone:`${cc} ${num}`})) }}
                            className="dark-input-r" style={{maxWidth:'90px',padding:'0 8px'}}>
                          ...
                          <input type="tel" value={form.phone.replace(/^\+\d+\s*/,'')} onChange={e => { const cc=form.phone.startsWith('+') ? form.phone.split(' ')[0] : '+91'; setForm(f=>({...f,phone:`${cc} ${e.target.value}`})) }} placeholder="98765 43210" className="dark-input-r" style={{flex:1}} />
                        </div>
                      </div>
                    </div>
                    <div className="form-group-r">
                      <label className="dark-label-r">Email address *</label>
                      <input type="email" value={form.email} onChange={set('email')} placeholder="jane@company.com" required className="dark-input-r" />
                    </div>
                    <div className="form-row">
                      <div className="form-group-r">
                      ...
                      <div className="form-group-r">
                        ...
                        <input type="password" value={form.confirmPassword} onChange={set('confirmPassword')} placeholder="••••••••" required className="dark-input-r"
                    ...
                    <div className="form-group-r">
                      ...
                      <input type="text" value={form.contactPerson} onChange={set('contactPerson')} placeholder="Primary contact name" className="dark-input-r" />
                    </div>
                    <div className="pb-30">
