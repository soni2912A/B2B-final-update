...
// import { Badge, Card, PageHeader, FilterBar, TableWrap, TblAction, Pagination, Btn, Loading, Modal, FormGroup, Input, Textarea } from '../../ui/index.jsx'
...
//             <TableWrap>
//               <thead>
//                 <tr><th>Company</th><th>Email</th><th>Phone</th><th>Orders</th><th>Credit Limit</th><th>Status</th><th>Actions</th></tr>
//               </thead>
//               <tbody>
//                 {corps.map(c => (
//                   <tr key={c._id}>
...
//         <FormGroup label="Phone"><Input value={form.phone} onChange={set('phone')} placeholder="+91 98765-43210" /></FormGroup>
